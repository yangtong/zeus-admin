...
class MetaTestCase(JinjaTestCase):
    ...
    def test_find_refererenced_templates(self):
        ast = env.parse('{% extends "index.html" %}{% include helper %}')
        i = meta.find_referenced_templates(ast)
        assert next(i) == 'index.html'
        assert next(i) is None
        assert list(i) == []

        ast = env.parse('{% extends "index.html" %}'
                        '{% from "test.html" import a, b as c %}'
                        '{% import "meh.html" as meh %}'
                        '{% include "muh.html" %}')
        i = meta.find_referenced_templates(ast)
        assert list(i) == ['index.html', 'test.html', 'meh.html', 'muh.html']
