...
class RoutingTestCase(WerkzeugTestCase):
    ...
    def test_alias_redirects(self):
        m = r.Map([
            r.Rule('/', endpoint='index'),
            r.Rule('/list.html', endpoint='index', alias=True),
            r.Rule('/users/', defaults={'page': 1}, endpoint='users'),
            r.Rule('/users/list.html', defaults={'page': 1}, alias=True,
                   endpoint='users'),
            r.Rule('/users/page/<int:page>', endpoint='users'),
        ...
        ensure_redirect('/list.html', '/')
        ensure_redirect('/users/list.html', '/users/')
